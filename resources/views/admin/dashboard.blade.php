            ...
            <div class="header-section">
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                        <h1>Welcome <strong>{{ Auth::user()->first_name }} </strong><br><small>This is the Dashboard!</small></h1>
                    </div>
                    <!-- END Main Title -->
                        ...
                        <div class="row text-center">
                            <div class="col-xs-4 col-sm-3">
                                <h2 class="animation-hatch">
                                    ...
                                    <small><i class="fa fa-thumbs-o-up"></i> Users</small>
                                </h2>
                            </div>
                            <div class="col-xs-4 col-sm-3">
                                <h2 class="animation-hatch">
                                    <strong>167k</strong><br>
                                    <small><i class="fa fa-heart-o"></i> Articles</small>
                                </h2>
                            </div>
                            <div class="col-xs-4 col-sm-3">
                                <h2 class="animation-hatch">
