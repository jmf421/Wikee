...
<section class="site-section site-section-light site-section-top themed-background-dark">
    <div class="container">
        <h1 class="text-center animation-slideDown"><i class="fa fa-support"></i> <strong>Search</strong></h1>
        <h2 class="h3 text-center animation-slideUp push">And you shall find..</h2>
        <div class="text-center">
            <form action="helpdesk.html" method="post" class="form-horizontal" onsubmit="return false;">
                <div class="form-group">
                    <div class="col-md-8 col-md-offset-2">
                        <label class="sr-only" for="helpdesk-question">Search</label>
                        <div class="input-group input-group-lg">
                            <input type="text" id="helpdesk-question" name="helpdesk-question" class="form-control" placeholder="Looking for something? Ask or enter a search term..">
                ...
                <aside class="sidebar site-block">
                    ...
                    <div class="sidebar-block">
                        <div class="alert alert-warning">
                            ...
                            <p>Didn't find what you were looking for? Feel free to <a href="contact.html" class="alert-link">contact us</a>.</p>
                        </div>
                    </div>
                    <!-- END Contact Us -->
